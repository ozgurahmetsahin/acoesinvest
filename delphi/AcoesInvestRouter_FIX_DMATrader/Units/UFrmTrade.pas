...
type
  ...
  public
    ...
    procedure BlinkCell(Col:TColumsShow; Symbol:String ; BlinkType:Integer);
  end;
...
uses UFrmMainTreeView, UFrmTradeCentral, UFrmBrokerBuy,UFrmBrokerSell,
  UFrmMiniBook, UFrmAbstractSymbol, UThrdDaileonFwRead, UFrmBook;

{$R *.dfm}

procedure TFrmTrade.BlinkCell(Col:TColumsShow; Symbol:String ; BlinkType:Integer);
var Rect:TRect;
    X:Integer;
    C,L:Integer;
begin
//Pegamos Rect da celula
   ...
   C:=TradeSheet.GetColumInteger(Col);
   L:=TradeSheet.GetLine(Symbol);
   Rect:=TradeSheet.CellRect(C,L);
//   TradeSheetDrawCell(TradeSheet,C,L,Rect,[gdSelected]);
   ...
   begin
      ...
      X:= Rect.Left + ( ( Rect.Right - Rect.Left) - TextWidth(TradeSheet.Cells[C,L]) - 3);
      TextRect(Rect,X ,Rect.Top + 3,TradeSheet.Cells[C,L]);
   end; // with canvas
end;
...
//  end;
 ...
 FrmBook.Edit1.Text:=TradeSheet.SelectedQuote;
 FrmBook.BitBtn1Click(Self);
 FrmBook.Show;
...
////    1:
////    begin
////       if FrmCentral.CentralSheet.GetValue(clLast,TradeSheet.Cells[0,ARow]) <> TradeSheet.Cells[ACol,ARow] then
////       begin
////
////          with TradeSheet.Canvas do
////          begin
...
////            Font.Style:=Font.Style + [fsBold];
////            X:= Rect.Left + ( ( Rect.Right - Rect.Left) - TextWidth(TradeSheet.Cells[ACol,ARow]) - 3);
////            TextRect(Rect,X ,Rect.Top + 3,FrmCentral.CentralSheet.GetValue(clLast,TradeSheet.Cells[0,ARow]));
////          end;
////          TradeSheet.Cells[ACol,ARow]:= FrmCentral.CentralSheet.GetValue(clLast,TradeSheet.Cells[0,ARow]);
////       end;
////
////    end;// 1
////  end;

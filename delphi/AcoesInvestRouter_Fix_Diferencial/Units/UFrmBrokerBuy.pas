...
begin
   ...
   begin
     ...
     begin
       MessageDlg('Para sua segurança, esta aplicação contêm uma trava de envio de ordens de venda com preço inferiores à 10% do preço atual do mercado.'
                  +#13+'Caso queira criar uma ordem com estes quesitos, por favor entre em contato com a mesa de operações de sua corretora.',mtInformation,[mbOk],0);
...
//    MessageDlg(MsgOrderBuy,mtConfirmation,[mbOk],0);
    ...
    if MessageDlg('Confirma o envio desta ordem e as ordens de start ou stop assinaladas?' +
                  #13 + 'Para segurança, os starts e stops estão validados somente para o pregão atual.' + #13 +
                  'Consulte a janela Start/Stop na guia Consulta de Ordens para verificar o envio de suas estratégias.',mtConfirmation,[mbYes,mbNo],0) = mrYes then
    begin
     ...
     begin
      ...
      begin
        ...
        MsgStop := '35=OSS' + #1 +
             ...
             '117='  + LabeledEdit1.Text + #1 +
             '53=' + LabeledEdit2.Text + #1 +
             '5033=' + FrmMainTreeView.ChangeDecimalSeparator(Edit2.Text,',','.') + #1 +
     ...
     begin
        ...
        begin
         ...
         '53=' +  LabeledEdit2.Text + // Quantidade a ser comprada ou vendida
         #1 +
         '44=' + ChangeDecimalSeparator( Edit1.Text,',','.' )  +  //  Preço Limite
         #1 +
        ...
        FrmMainTreeView.AddLogMsg(MsgOrderBuy);
        FrmMainTreeView.SaveLog;
        ...
        //Monta a Msg para o broker
          MsgStart:= '35=OSB' + #1 +
                     ...
                     '53=' + LabeledEdit2.Text + #1 +
                     '5022=' + FrmMainTreeView.ChangeDecimalSeparator(Edit2.Text,',','.') + #1 +
                     '44=' + FrmMainTreeView.ChangeDecimalSeparator(Edit2.Text,',','.') + #1 +
                     '5018=0' + #1 +
         ...
         FrmMainTreeView.AddLogMsg(MsgStart);

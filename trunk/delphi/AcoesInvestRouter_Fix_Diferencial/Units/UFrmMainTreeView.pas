...
uses
  ...
  IdTCPClient, WinSkinData, StdCtrls, ExtCtrls,UFrmMiniBook,TlHelp32,PsAPI,ShellApi,
...
type
  ...
  public
    ...
    const DefaultTradeHost : String = 'server2.acoesinvest.com.br';
    //Host padrão de negociacao
    const DefaultRouterHost : String = 'broker.acoesinvest.com.br';

    // Versao do sistema
    const VersionID:String = '1.0';

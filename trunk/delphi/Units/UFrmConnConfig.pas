...
begin
 ...
 try
   ...
   lblEditSvrSignal.Text:= Config.ReadString('SIGNAL','Server','server2.acoesinvest.com.br');
   lblEditPortSignal.Text:= Config.ReadString('SIGNAL','Port','81');
   ...
   lblEdtSvrBroker.Text:= Config.ReadString('BROKER','Server','broker.acoesinvest.com.br');
   lblEdtPortBroker.Text:= Config.ReadString('BROKER','Port','81');
   ...
   begin
     ...
     begin
       Host:= Config.ReadString('SIGNAL','Server','server2.acoesinvest.com.br');
...
begin
 {Restaura padrão}
 lblEdtSvrBroker.Text:='broker.acoesinvest.com.br';
...
begin
 {Restaura padrão}
 lblEditSvrSignal.Text:='server2.acoesinvest.com.br';
 lblEditPortSignal.Text:='81';

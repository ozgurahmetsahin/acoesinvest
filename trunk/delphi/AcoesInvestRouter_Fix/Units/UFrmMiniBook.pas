...
uses
  ...
  Dialogs, Grids, ExtCtrls,Sheet, StdCtrls, Buttons,IniFiles, Tabs;
...
type
  TFrmMiniBook = class(TForm)
    ...
    procedure DadosKeyPress(Sender: TObject; var Key: Char);
    procedure DadosDrawCell(Sender: TObject; ACol, ARow: Integer;
...
begin
     ...
     if StringGrid1.RowCount < ( L + 1) then
     StringGrid1.RowCount:=L + 6;

     //Compra ou venda
     if Direction = 'A' then
     begin
       //Manda tudo pra baixo
       for I := StringGrid1.RowCount -1 downto L do
       begin
...
//Se não existir na lista geral, adiciona
    try
      ...
      FrmMainTreeView.DaileonFW.IOHandler.WriteLn('bqt ' + LowerCase(Symbol));
      Self.Caption:=Symbol;
...
//Somente ela ( tipo 1 )
     ...
     begin
        ...
        begin
          ...
          for I := L+1 to StringGrid1.RowCount -1 do
          begin
...
begin
  Dados.Cells[0,0]:= 'Comprador';
  Dados.Cells[1,0]:= 'Qtde.';
  Dados.Cells[2,0]:= 'Preço';
  Dados.Cells[3,0]:= 'Preço';
  Dados.Cells[4,0]:= 'Qtde.';
  Dados.Cells[5,0]:= 'Vendedor';
end;
...
procedure TFrmMiniBook.SpeedButton1Click(Sender: TObject);
var
  I: Integer;
begin
 Dados.RowCount:=6;
...
procedure TFrmMiniBook.SpeedButton2Click(Sender: TObject);
var
  I: Integer;
begin
 Dados.RowCount:=11;
...
procedure TFrmMiniBook.SpeedButton3Click(Sender: TObject);
var
  I: Integer;
begin
 Dados.RowCount:=StringGrid1.RowCount;
end;

procedure TFrmMiniBook.DadosDblClick(Sender: TObject);
begin
...
procedure TFrmMiniBook.DadosDrawCell(Sender: TObject; ACol, ARow: Integer;
  Rect: TRect; State: TGridDrawState);
...
procedure TFrmMiniBook.DadosKeyPress(Sender: TObject; var Key: Char);
begin
  Edit1.Text:=Key;
  Edit1.SetFocus;
...
procedure TFrmMiniBook.TabSet1Change(Sender: TObject; NewTab: Integer;
  var AllowChange: Boolean);
begin
 case NewTab of
...
begin
try
  for I := 1 to Dados.RowCount - 1 do
  begin
    Dados.Cells[0,I]:=StringGrid1.Cells[0,I];
    Dados.Cells[1,I]:=StringGrid1.Cells[1,I];
    Dados.Cells[2,I]:=StringGrid1.Cells[2,I];
  end;
...
procedure TFrmMiniBook.Timer2Timer(Sender: TObject);
var
  I: Integer;
begin
try
  for I := 1 to Dados.RowCount - 1 do
  begin
    Dados.Cells[3,I]:=StringGrid1.Cells[3,I];
    Dados.Cells[4,I]:=StringGrid1.Cells[4,I];
    Dados.Cells[5,I]:=StringGrid1.Cells[5,I];
  end;
